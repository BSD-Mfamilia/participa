...
feature "Microcredits" do
  ...
  scenario "new loan - anonymous user" do
    ...
    page.must_have_content "Acepto las condiciones generales del Contrato civil de suscripción de microcréditos de Más Madrid"
    ...
    click_button "Guardar Suscripción"
    page.must_have_content "En unos segundos recibirás un correo electrónico con toda la información necesaria para finalizar el proceso de suscripción del microcrédito Más Madrid"
  end
